...
public class JogoDaora{
	...
	public static void jogo(int i)throws InterruptedException{ //Exceção criada especificamente para pausas durante os diálogos.
		...
		nome = input.next(); //Abastecendo a variável com a escolha de nome do usuário
		System.out.println("Em qual parque voce gostaria de morar como um ganso abencoado? So o nome, se possivel.  A nao utilizacao de espacos e bem vinda");
		lugar = input.next(); //Abastecendo a variável com a escolha de lugar do usuário
